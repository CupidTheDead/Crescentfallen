...
import fracture.mod.planets.thefracture.thefracture.biome.gen.GenLayerTheFracture;
...
public class BiomeProviderTheFracture extends BiomeProvider {
	...
	protected BiomeProviderTheFracture() {
		this.body = CFplanets.fracture;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderTheFracture(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerTheFracture.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderTheFracture(World world) {
