...
public class ChunkProviderdreamyard extends ChunkProviderDreamyardBase {
	...
	private final MapGenAddonCaveGen caveGenerator = new MapGenAddonCaveGen(BlockInit.OVERGRASS_BLOCK.getDefaultState(),
			Blocks.LAVA.getDefaultState(), Sets.newHashSet(BlockInit.OVERGRASS_BLOCK, BlockInit.DREAMSTONE));
	...
	public ChunkProviderdreamyard(World par1World, long seed, boolean mapFeaturesEnabled) {
