...
public class SkyProviderHollows extends IRenderHandler {
	...
	private static final ResourceLocation sunTexture = new ResourceLocation(ModInfo.ID, "textures/gui/celestialbodies/triopas.png");
	...
	public SkyProviderHollows(IGalacticraftWorldProvider mercuryProvider) {
