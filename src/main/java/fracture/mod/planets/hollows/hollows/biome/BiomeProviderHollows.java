...
public class BiomeProviderHollows extends BiomeProvider {
	...
	public BiomeProviderHollows(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerHollows.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderHollows(World world) {
