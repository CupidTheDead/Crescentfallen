...
import fracture.mod.world.chunk.ChunkProviderHollowsBase;
...
//public class ChunkProviderHollows extends ChunkProviderBase {
public class ChunkProviderHollows extends ChunkProviderHollowsBase {
	...
	private final MapGenAddonCaveGen caveGenerator = new MapGenAddonCaveGen(BlockInit.STONE_HOLLOWS.getDefaultState(),
			Blocks.LAVA.getDefaultState(), Sets.newHashSet(BlockInit.STONE_HOLLOWS, BlockInit.STONE_HOLLOWS));
