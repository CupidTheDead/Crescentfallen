...
public class CloudsHollows extends IRenderHandler{


	
	    private static final ResourceLocation cloudsRed = new ResourceLocation("textures/environment/clouds.png");

	    @Override
	    public void render(float partialTicks, WorldClient world, Minecraft mc)
	    {
	        System.out.println("[CloudsHollows] Rendering custom clouds.");

	    	
	    	
	    	int cloudTickCounter = (int) (mc.world.getTotalWorldTime() & 0xFFFFFFF); // wrap to avoid overflow
	        ...
	        float f2 = 12.0F;
	        float f3 = 4.0F;
	        mc.renderEngine.bindTexture(CloudsHollows.cloudsRed);
