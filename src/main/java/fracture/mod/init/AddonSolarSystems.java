...
public class AddonSolarSystems {
	...
	private void createSolarSystems() {
		...
		addonSystem1 = new SolarSystem("Triopas", "milky_way").setMapPosition(new Vector3(1.2F, 0.3f, 0.0f));
		Star iStar = new Star("triopas").setParentSolarSystem(addonSystem1);
		iStar.setTierRequired(-1);
		
		iStar.setBodyIcon(new ResourceLocation(ModInfo.ID, "textures/gui/celestialbodies/triopas.png"));
		//iStar.setBodyIcon(new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/triopas.png"));
		//iStar.setBodyIcon(new ResourceLocation(Constants.ASSET_PREFIX, "textures/planets/triopas.png"));
