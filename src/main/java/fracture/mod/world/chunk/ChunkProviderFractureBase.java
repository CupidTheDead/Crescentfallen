...
public abstract class ChunkProviderFractureBase extends ChunkProviderCommon {
	
		protected static final IBlockState STONE = BlockInit.STONE_FRACTURE.getDefaultState();
		protected static final IBlockState GRAVEL = BlockInit.BURNT_STONE_FRACTURE.getDefaultState();
		protected static final IBlockState WATER = GCBlocks.crudeOil.getDefaultState();
		//protected static final IBlockState WATER = Blocks.LAVA.getDefaultState();
		protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
		protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
		
		//protected static final fracture.mod.planets.thefracture.thefracture.biome.gen.feature.WorldGenTheFractureburns WorldGenTheFractureburns = new WorldGenTheFractureburns(false);
		...
		//private MapGenAddonCaveGen caveGenerator;
		private MapGenBase caveGenerator;
		// private MapGenBaseMeta bigCaveGenerator;

		public ChunkProviderFractureBase(World worldIn, long seed, boolean mapFeaturesEnabled) {
//THIS PART CHANGED TO ADD BOOLEAN
			this.world = worldIn;
			...
			//caveGenerator = fracture.mod.world.MapGenAddonCaveGen(new MapGenCaves(), net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.CAVE);
...
//THIS USED TO HAVE AN OVERRIDE TAG
		
		//you added the WORLDOBJ TAG (protected World worldObj;) AT THE TOP OF THIS.
