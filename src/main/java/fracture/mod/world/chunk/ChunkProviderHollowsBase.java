...
public abstract class ChunkProviderHollowsBase extends ChunkProviderCommon {
	
		protected static final IBlockState STONE = BlockInit.STONE_HOLLOWS.getDefaultState();
		protected static final IBlockState GRAVEL = Blocks.PACKED_ICE.getDefaultState();
		protected static final IBlockState WATER = Blocks.PACKED_ICE.getDefaultState();
		...
		public ChunkProviderHollowsBase(World worldIn, long seed, boolean mapFeaturesEnabled) {
...
//public int getCraterProbability() {
    // Lower = more craters (e.g., 100), higher = fewer craters (e.g., 500)
//    return 300;
//}
