...
public abstract class ChunkProviderDreamyardBase extends ChunkProviderCommon {
	
	//stones visibility changed to public..
	public static final IBlockState STONE = BlockInit.DREAMSTONE.getDefaultState();
	protected static final IBlockState GRAVEL = BlockInit.GRAVEL_DREAMYARD.getDefaultState();
	...
	public ChunkProviderDreamyardBase(World worldIn, long seed, boolean mapFeaturesEnabled) {
