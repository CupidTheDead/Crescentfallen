...
public abstract class ChunkProviderHollowsTemp extends ChunkProviderAbst {
	
		protected static final IBlockState STONE = BlockInit.STONE_KONA.getDefaultState();
		protected static final IBlockState GRAVEL = BlockInit.TRASH_PILE.getDefaultState();
		...
		public ChunkProviderHollowsTemp(World worldIn, long seed, boolean mapFeaturesEnabled) {
